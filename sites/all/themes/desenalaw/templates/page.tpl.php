...
?>
  ...
  <div id="page-wrapper"><div><div>
    <div class="clear"></div>
    <div role="banner" id="header"><div class="container"><div>
      <?php print $messages; ?>
      <div class="btn-menu">
        <a role="presentation" href="#"><span class="sr-only">Open menu</span></a>
      </div>
      <div class="facebook-link"><a href="https://www.facebook.com/DeSenaLaw/" target="_blank"><span class="sr-only">Facebook</a></div>
      <div class="email-link"><a href="/contact"><span class="sr-only">Email Us</a></div>
      <div class="clear"></div>
    ...
    <div id="main-wrapper"><div><div>
      <div role="main" id="content"><div class="container"><div>
        ...
        <?php if ($title): ?><div id="page-title"><div><div><div><h1 class="title"><?php print $title; ?></h1></div></div></div></div><?php endif; ?>
    ...
    <div class="clear"></div>
    <div role="contentinfo" aria-label="Footer" id="footer"><div><div>
      <?php print render($page['footer']); ?>
      <div id="footer-info">
        <div id="copyright"><span class="text-helv">&copy;</span> Francis De Sena Law Firm <?php print date('Y'); ?></div>
